    ...
    <div className="h-full flex flex-col bg-zinc-50/50 dark:bg-zinc-950/50 relative">
      ...
      <div className="h-16 px-4 md:px-10 border-b border-zinc-200/60 dark:border-zinc-800/60 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between gap-2 shrink-0">
        ...
        <div className="flex items-center gap-3 md:gap-4 overflow-x-auto no-scrollbar">
            ...
            {/* Delete Entire Prompt (Only valid for existing prompts) */}
            {initialData && (
                <>
                    <button 
                        type="button"
                 ...
                 <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="">
                         <textarea 
                            ...
                            placeholder="Describe the purpose, goals, or context of this prompt. Support Markdown for images: ![alt](url)..."
                            className="w-full text-sm text-zinc-700 dark:text-zinc-300 bg-transparent border-none p-0 focus:ring-0 placeholder:text-zinc-300 dark:placeholder:text-zinc-700 resize-none leading-relaxed font-mono"
                        />
                    </div>

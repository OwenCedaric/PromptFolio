    ...
    <div className="h-full flex flex-col bg-zinc-50/50 dark:bg-zinc-950/50 relative overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden relative min-h-0">
        <div className="h-full max-w-[1920px] mx-auto lg:grid lg:grid-cols-12 lg:divide-x lg:divide-zinc-200 dark:lg:divide-zinc-800">
            ...
            {/* Unified scrolling container including the toolbar */}
            <div className={`lg:col-span-7 h-full overflow-y-auto scrollbar-hide pb-32 lg:pb-0 ${mobileTab === 'prompt' ? 'hidden lg:block' : 'block'}`}>
                
                 {/* Toolbar moved inside scroll flow */}
                ...
                <div className="p-6 md:p-10 pt-4 space-y-8">
                    {/* Title Input */}
                    <div>
                        <input 
                            type="text" 
